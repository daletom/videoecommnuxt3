        ...
        <div class="border-b border-gray-200">
          <div class="h-16 flex items-center justify-between">
            ...
            <a href="/" class="flex">
              ...
              <img class="h-8 w-auto" src="https://ix-www.imgix.net/press/imgix-press-kit.pdf?page=5&w=100&fm=png" alt="" />
            </a>
    ...
    <main class="max-w-7xl mx-auto sm:pt-16 sm:px-6 lg:px-8">
          ...
          <TabGroup as="div" class="flex flex-col-reverse">
              ...
              <TabList class="grid grid-cols-4 gap-6">
                <Tab v-for="image in product.images" :key="image.id" class="relative h-24 bg-white rounded-md flex items-center justify-center text-sm font-medium uppercase text-gray-900 cursor-pointer hover:bg-gray-50 focus:outline-none focus:ring focus:ring-offset-4 focus:ring-opacity-50" v-slot="{ selected }">
                  ...
                  <span class="absolute inset-0 rounded-md overflow-hidden">
                    <img
                      :src="image.src + '&w=107'"
                      :srcset="image.src + '&w=107 1x, ' + image.src + '&w=107&dpr2 2x, ' + image.src + '&w=107&dpr=2.5 3x'"
                      alt=""
            ...
            <TabPanels class="w-full aspect-w-1 aspect-h-1">
              <TabPanel v-for="image in product.images" :key="image.id">
                <img
                  :src="image.src + '&w=557&h=557'"
                  :srcset="image.src + '&w=557&h=557 1x, ' + image.src + '&w=557&h=557&dpr2 2x, ' + image.src + '&w=557&h=557&dpr=2.5 3x'"
                  :alt="image.alt"
      ...
      <section aria-labelledby="details-heading">
        <div class="flex flex-col items-center text-center">
          <h2 id="details-heading" class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Using Youtube Videos</h2>
          ...
          <div>
            <div class="w-full aspect-w-3 aspect-h-2 rounded-lg overflow-hidden">
              <video muted autoplay loop class="w-full">
                <source src="https://assets.imgix.net/changelog/changelog_20170526_02.gif?fm=mp4&w=.5" type="video/mp4">
              </video>
            </div>
    ...
    <footer aria-labelledby="footer-heading" class="bg-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="border-t border-gray-200 py-20">
          <div class="grid grid-cols-1 md:grid-cols-12 md:grid-flow-col md:gap-x-8 md:gap-y-16 md:auto-rows-min">
            ...
            <div class="col-span-1 md:col-span-2 lg:row-start-1 lg:col-start-1">
              <img src="https://ix-www.imgix.net/press/imgix-press-kit.pdf?page=5&w=100&fm=png" alt="" class="h-8 w-auto" />
            </div>
        ...
        <div class="border-t border-gray-100 py-10 text-center">
          <p class="text-sm text-gray-500">2022 Zebrafish Labs, LLC All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
  ...
  images: [
    {
      id: 1,
      name: 'Angled view',
      src: 'https://tom.imgix.net/examples/ecomm/ix_holo_sticker.jpg?fit=crop&crop=edges&auto=format,compress&cs=srgb',
      alt: 'Holographic Stickers.',
    },
    {
      id: 2,
      name: 'Angled view',
      src: 'https://tom.imgix.net/examples/ecomm/ix_holo_sticker.jpg?fit=crop&crop=edges&auto=format,compress&cs=srgb&rot=90',
      alt: 'Holographic Stickers.',
    },
    // More images...
  ],
